...
export const LendingDepositOrWithdraw = (props) => {
        ...
        if (isApproved) {
            return (
                <div style={{'display': 'flex', 'flex-direction': 'column', 'justify-content': 'center'}}>
                    ...
                    <NumberInput variant="outlined" value={tokenAmount} placeholder="0"
    ...
    const deposit = async () => {
        ...
        await poolInstance.methods._stake(tokenAmountBigNumber).send({
